	...
	//		long startTime=System.currentTimeMillis();
		...
		/*	while (System.currentTimeMillis()-startTime < 5000)
			...
			*/
			...
			vrep.simxCreateDummy(clientID,(float)0.1,null,Dumhandle,vrep.simx_opmode_oneshot_wait); 
			int dummyHandle = Dumhandle.getValue();

			System.out.println(dummyHandle);
			
			FloatWA tmpF = new FloatWA(3);
			vrep.simxGetObjectPosition(clientID,dummyHandle,-1,tmpF,vrep.simx_opmode_oneshot_wait);			
			vrep.simxSetObjectPosition(clientID,handle,-1,tmpF,vrep.simx_opmode_oneshot);
			
			IntW Dumhan1dle = new IntW(0);
			vrep.simxCreateDummy(clientID,(float)0.1,null,Dumhandle,vrep.simx_opmode_oneshot_wait); 
			int dummyH1andle = Dumhan1dle.getValue();
